...
use near_sdk::{Gas, NearToken, PromiseError, PromiseResult};
...
impl ContextConfigs {
    ...
    pub fn deploy_proxy_contract(&mut self, context_id: Repr<ContextId>, account_id: AccountId) -> Promise {
