...
import { idlFactory } from './context_contract.did.js';
export { idlFactory } from './context_contract.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_CONTEXT_CONTRACT;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./context_contract.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the context_contract canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./context_contract.did.js")._SERVICE>}
 */
export const context_contract = createActor(canisterId);
