...
Welcome to your new `icp_context_contract` project and to the Internet Computer
...
To learn more before you start working with `icp_context_contract`, see the
following documentation available online:
