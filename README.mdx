...
graph TB
    ...
    subgraph "DAG Fork Detection"
        F[After broadcast<br/>All nodes have:<br/>D1A, D1B, D1C<br/>━━━━━━━━━━━<br/>DAG heads: [D1A, D1B, D1C]<br/>⚠️ FORK DETECTED]
    end
    ...
    subgraph "Next Operation Creates Merge Delta"
        M2[Any node's next op<br/>Create D2<br/>parents: [D1A, D1B, D1C]<br/>━━━━━━━━━━━<br/>DAG head: [D2]<br/>✅ FORK RESOLVED]
    end
    ...
    style C1B fill:#ffe1e1
    style C1C fill:#ffe1e1
    style F fill:#fff3cd
    style M1 fill:#c3e6cb
