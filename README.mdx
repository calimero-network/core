...
End-to-end tests are automatically run via GitHub Actions workflows:

- **`merobox-workflows.yml`** - Runs merobox workflows for all applications in `apps/` to validate functionality
- **`merobox-proposals.yml`** - Tests blockchain integration proposals for NEAR, ICP, and Ethereum protocols
