...
<CardGrid>
  <LinkCard title="Advanced SDK" href="/build/advanced-sdk/" description="The deeper mechanics behind the determinism, merge, and xcall edges above." />
  <LinkCard title="Storage performance & Big-O" href="/build/storage-complexity/" description="Why writes rehash siblings and how to keep collections fast." />
  <LinkCard title="Access-controlled storage" href="/build/permissioned-storage/" description="How the Public write boundary and merge-plane enforcement work." />
</CardGrid>
