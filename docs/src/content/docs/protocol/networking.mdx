...
| `/calimero/blob-announce/1.0.0` | "I now hold this blob for this context", sent to a context's availability nodes |
...
StateDelta {
  ...
  delta_signature: Option<[u8;64]>, producing_bytecode_id: Option<[u8;32]>,
}
```
