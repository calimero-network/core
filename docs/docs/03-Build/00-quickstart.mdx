...
- frontend should have defined wasm hash as application id it accepts
- enable frontend to specify node url
- publish frontend to github pages
- open frontend and set node url
- login to frontend and query for contexts which support that application id
- select context from list or create new context from frontend
