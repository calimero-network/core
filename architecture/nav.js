...
(function () {
  ...
  const NAV = [
    ...
    { label: '2 · Identities & Keys', href: 'protocol/identities.html', dot: '#a5ff11', sub: true },
    ...
    { label: '5 · Application Execution', href: 'protocol/execution.html', dot: '#a5ff11', sub: true },
    { label: '6 · Governance', href: 'protocol/governance.html', dot: '#a5ff11', sub: true },
    { label: '7 · Networking & Wire', href: 'protocol/networking.html', dot: '#a5ff11', sub: true },
  ...
  function buildToc() {
    ...
    headings.forEach((h, i) => {
      if (!h.id) h.id = 'toc-' + i + '-' + h.textContent.trim().toLowerCase().replace(/[^a-z0-9]+/g, '-').replace(/-+$/, '');
    });
