...
| `fugue-editor`           | Collaborative text on `FugueText` | `FugueText` twin of `collaborative-editor`; guest for `crates/runtime/tests/fugue_wall.rs` |
| `fugue-collab`           | Collaborative text on `FugueText`, with deletes | E2E guest; keeps e2e-only surface off `fugue-editor` |
