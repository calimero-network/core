...
BUILD_SCRIPTS=(
    ...
    "apps/migrations/migration-suite-v1/build.sh"
    "apps/migrations/migration-suite-v2-add-field/build.sh"
    "apps/migrations/migration-suite-v3-remove-field/build.sh"
    "apps/migrations/migration-suite-v4-rename-field/build.sh"
    "apps/migrations/migration-suite-v5-change-type/build.sh"
