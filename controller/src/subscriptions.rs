use primitives::{api::WsClientId, app::InstalledAppId};
use std::collections::{HashMap, HashSet};

pub(crate) struct Subscriptions {
    /// Key is app_id, value is set of clients to which client is subscribed.
    app_to_clients: HashMap<InstalledAppId, HashSet<WsClientId>>,
    /// Key is client_id, value is set of app_ids to which client is subscribed.
    client_to_apps: HashMap<WsClientId, HashSet<InstalledAppId>>,
}
...
impl Subscriptions {
    ...
    pub(crate) fn subscribe(&mut self, app_id: InstalledAppId, client_id: WsClientId) {
        self.app_to_clients
            .entry(app_id)
    ...
    pub(crate) fn unsubscribe(&mut self, app_id: InstalledAppId, client_id: WsClientId) {
        self.app_to_clients
            .get_mut(&app_id)
    ...
    pub(crate) fn unsubscribe_from_all(&mut self, client_id: WsClientId) {
