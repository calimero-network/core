...
| Item | Kind | Purpose |
| --- | --- | --- |
| `GroupOp` | enum, `#[non_exhaustive]` | Mutation of a single group's state (membership, roles, capabilities, metadata, TEE policy, cascades, key rotation, the account's device registry) |
