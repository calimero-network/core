...
use crate::config::{SyncConfig, RetryConfig};
use crate::events::SyncEvent;
use crate::strategies::{SyncStrategy, SyncResult};
...
impl SyncScheduler {
    ...
    pub async fn sync_context(
        ...
        // Mark as active
        {
            ...
            active.insert(*context_id, SyncState {
                peer_id: *peer_id,
        ...
        // Emit started event
        let _ = self.event_tx.send(SyncEvent::started(*context_id, *peer_id));
    ...
    async fn execute_with_retry(
        ...
        for attempt in 0..=retry_config.max_retries {
            ...
            match strategy.execute(context_id, peer_id, our_identity, delta_store).await {
        ...
        Err(eyre!("Sync failed after {} retries", retry_config.max_retries))
    }
