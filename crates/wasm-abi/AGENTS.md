...
| `CrdtCollectionType` | enum (`#[non_exhaustive]`) | `LwwRegister`, `Counter`, `Vector`, `UnorderedMap`, `SortedMap`, `AuthoredMap`, `AuthoredSortedMap`, `UnorderedSet`, `SortedSet`, `ReplicatedGrowableArray`, `AuthoredVector`, `SharedStorage` |
