...
pub(crate) fn setup(
    ...
    let protected_router = Router::new()
        ...
        .route(
            "/install-application",
            post(handlers::applications::install_application_handler),
        )
        .route(
            "/applications",
            get(handlers::applications::list_applications_handler),
        )
        .route(
            "/applications/:app_id",
            get(handlers::applications::get_application_details_handler),
        )
        ...
        .route(
            ...
            get(handlers::context::get_context_identities_handler),
        )
        .route(
