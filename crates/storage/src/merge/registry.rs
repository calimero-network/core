...
// =============================================================================
// Injectable MergeRegistry (for testing and isolated contexts)
// =============================================================================
...
// =============================================================================
// Global registry (for production use)
// =============================================================================
...
mod tests {
    ...
    //
    // NOTE: These tests use global state and may interfere with each other
    // when run in parallel. They are marked #[ignore] by default.
    // Run with `cargo test -- --ignored` to execute them serially.
    // =========================================================================

    #[test]
    #[ignore = "Uses global state, run with --ignored for serial execution"]
