...
use crate::messages::execute::{ExecuteRequest, ExecuteResponse, ExecuteError};
...
impl ContextClient {
    ...
    pub async fn get_contexts(&self, start: Option<ContextId>) -> impl Stream<Item = eyre::Result<ContextId>> {
    ...
    pub async fn update_application(
        ...
        self.context_manager.send(ContextMessage::UpdateApplication {
        ...
        receiver.await.expect("Context manager not to drop response channel")
    }
    ...
    pub async fn create_context(
        ...
        self.context_manager.send(ContextMessage::CreateContext {
    ...
    pub async fn execute(
        ...
        self.context_manager.send(ContextMessage::Execute {
