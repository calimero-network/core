...
use crate::group::{
    ...
    EnsureAccountNamespaceRequest, FollowNamespaceRequest, GetCascadeStatusRequest,
    ...
    PairDeviceInitRequest, RelinkDeviceRequest, RemoveGroupMembersRequest, ResyncContextRequest,
...
pub enum ContextMessage {
    ...
    EnsureAccountNamespace {
        request: EnsureAccountNamespaceRequest,
        outcome: oneshot::Sender<<EnsureAccountNamespaceRequest as Message>::Result>,
    },
    FollowNamespace {
        request: FollowNamespaceRequest,
        outcome: oneshot::Sender<<FollowNamespaceRequest as Message>::Result>,
    },
    RevokeDevice {
    ...
    RotateGroupKey {
        ...
        outcome: oneshot::Sender<<RotateGroupKeyRequest as Message>::Result>,
    },
