...
use calimero_context_config::client::{AnyTransport, Client as ConfigClient};
...
pub struct ContextClient {
    ...
    #[cfg(feature = "external_client")]
    external_client: ConfigClient<AnyTransport>,
...
#[cfg(feature = "external_client")]
impl std::ops::Deref for ExternalClient<'_> {
    type Target = ConfigClient<AnyTransport>;
...
impl ContextClient {
    ...
    #[cfg(not(feature = "external_client"))]
    pub fn new(
        datastore: Store,
        node_client: NodeClient,
        context_manager: LazyRecipient<ContextMessage>,
