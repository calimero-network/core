...
impl Handler<GrantContextCapabilitiesRequest> for ContextManager {
    type Result = ActorResponse<Self, <GrantContextCapabilitiesRequest as Message>::Result>;

    fn handle(
        &mut self,
        GrantContextCapabilitiesRequest {
            context_id,
            capabilities,
            signer_id,
        }: GrantContextCapabilitiesRequest,
