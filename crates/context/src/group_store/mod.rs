...
pub use self::membership::{
    ...
    count_group_members, delete_all_group_members, get_group_member_role, get_group_member_value,
    is_direct_group_admin, is_group_admin, is_group_admin_or_has_capability, list_group_members,
    remove_group_member, require_group_admin, require_group_admin_or_capability,
...
pub use self::namespace::{
    ...
    resolve_namespace_identity_record, store_namespace_identity, unnest_group,
