...
pub use self::membership::{
    ...
    has_direct_group_member, is_authoritative_namespace_identity, is_direct_group_admin,
    is_group_admin, is_group_admin_or_has_capability, is_inherited_admin, list_group_members,
