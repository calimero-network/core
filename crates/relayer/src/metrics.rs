...
impl RelayerMetrics {
    ...
    pub fn new(registry: &mut Registry) -> Self {
        ...
        mock_registry.register(
            "operations_total",
            "Total number of mock relayer operations",
    ...
    pub fn inc_mock_operations(&self, operation: &str) {
    ...
    pub fn record_http_response_size(&self, method: &str, path: &str, status_code: &str, size: f64) {
