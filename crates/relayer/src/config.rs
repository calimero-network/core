...
impl Default for RelayerConfig {
    fn default() -> Self {
        ...
        drop(protocols.insert("starknet".to_string(), ProtocolConfig {
            enabled: false,
            network: "sepolia".to_string(),
            rpc_url: "https://free-rpc.nethermind.io/sepolia-juno/".parse().unwrap(),
            contract_id: "0x1b991ee006e2d1e372ab96d0a957401fa200358f317b681df2948f30e17c29c".to_string(),
            credentials: Some(ProtocolCredentials::Starknet {
                account_id: "0x01cf4d57ba01109f018dec3ea079a38fc08b0f8a78eed0d4c5e5fb22928dbc8c".to_string(),
                public_key: "0x02c5dbad71c92a45cc4b40573ae661f8147869a91d57b8d9b8f48c8af7f83159".to_string(),
                secret_key: "0x0178eb2a625c0a8d85b0a5fd69fc879f9884f5205ad9d1ba41db0d7d1a77950a".to_string(),
            }),
        }));
        
        // Default ICP configuration (disabled by default, but with working credentials when enabled)
        drop(protocols.insert("icp".to_string(), ProtocolConfig {
            enabled: false,
            ...
            credentials: Some(ProtocolCredentials::Icp {
                ...
                public_key: "MCowBQYDK2VwAyEAL8XDEY1gGOWvv/0h01tW/ZV14qYY7GrHJF3pZoNxmHE=".to_string(),
                secret_key: "MFECAQEwBQYDK2VwBCIEIJKDIfd1Ybt7xliQlRmXZGRWG8dJ1Dl9qKGT0pOhMwPjaE30".to_string(),
            }),
        }));
        
        // Default Ethereum configuration (disabled by default, but with working credentials when enabled)
        drop(protocols.insert("ethereum".to_string(), ProtocolConfig {
            enabled: false,
            network: "sepolia".to_string(),
            ...
            credentials: Some(ProtocolCredentials::Ethereum {
                ...
                secret_key: "0ac1e735c1ca39db4a9c54d4edf2c6a50a75a3b3dce1cd2a64e8f5a44d1e2d2c".to_string(),
            }),
        }));
