// Set version and build metadata env vars for the binary (NEAR-style: env vars in binary's build).
...
fn main() {
    ...
    println!("cargo:rustc-env=MEROD_VERSION={}", env!("CARGO_PKG_VERSION"));
